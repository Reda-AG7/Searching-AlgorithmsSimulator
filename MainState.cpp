...
MainState::MainState(sf::RenderWindow* window, sf::Font& titleFont, sf::Font& regularFont) {
    ...
    buttons[4] = new Button(window->getSize().x / 2.0f, start + 195.0f, 300.0f, 50.0f, "Dijkstra", regularFont, 25u, sf::Color::White);
    buttons[3] = new Button(window->getSize().x / 2.0f, start + 260.0f, 180.0f, 50.0f, "Exit", regularFont, 25u, sf::Color::White);
}
